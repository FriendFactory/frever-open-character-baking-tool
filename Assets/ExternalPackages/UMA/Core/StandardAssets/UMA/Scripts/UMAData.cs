...
#pragma warning restore 618
		...
		public class UMARecipe
		{
			...
			{
				get => _slotDataList;
				set => _slotDataList = value;
			}
			private SlotData[] _slotDataList;
...
#pragma warning restore 618
			...
			public void SetSlot(int index, SlotData slot)
			{
				...
				{
					System.Array.Resize<SlotData>(ref _slotDataList, index + 1);
				}
			...
			public SlotData MergeSlot(SlotData slot, bool dontSerialize)
			{
				...
				System.Array.Resize<SlotData>(ref _slotDataList, slotDataList.Length + 1);
